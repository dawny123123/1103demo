...
| 文件路径 | `/Users/yuxiao/Downloads/0713demo/test.db` | 绝对路径，避免相对路径问题 |
...
**节来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L18-L30)
...
- **协议前缀**: `jdbc:sqlite:`
- **数据库文件路径**: `/Users/yuxiao/Downloads/0713demo/test.db`
...
**节来源**
- [DBUtil.java](file://src/main/java/com/example/demo/dao/DBUtil.java#L8-L11)
...
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L20-L22)
...
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L52-L87)
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L89-L110)
