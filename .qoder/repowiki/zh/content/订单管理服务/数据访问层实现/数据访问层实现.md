...
<cite>
**本文档中引用的文件**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java) - *已更新，包含完整的CRUD接口*
...
**图表来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L1-L186)
...
**图表来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L10-L186)
...
**图表来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L155-L162)

**章节来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L155-L186)
...
**图表来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L16-L26)
...
**图表来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L29-L56)
...
**图表来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L59-L79)
...
**章节来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L16-L79)
- [DBUtil.java](file://src/main/java/com/example/demo/dao/DBUtil.java#L1-L19)
...
**图表来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L164-L171)
...
```mermaid
flowchart TD
Start([getOrdersByUserId调用]) --> CheckUserId{"检查userId有效性"}
CheckUserId --> |无效| ReturnEmpty["返回空列表"]
CheckUserId --> |有效| FilterOrders["过滤用户订单"]
FilterOrders --> SortOrders["按创建时间降序排序"]
SortOrders --> ReturnResult["返回结果列表"]
ReturnEmpty --> End([结束])
ReturnResult --> End
```

**图表来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L173-L182)
...
```mermaid
flowchart TD
Start([getAllOrders调用]) --> GetValues["获取所有订单值"]
GetValues --> SortOrders["按创建时间降序排序"]
SortOrders --> ReturnResult["返回结果列表"]
ReturnResult --> End([结束])
```

**图表来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L184-L186)
...
**图表来源**
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L17-L26)
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L31-L56)
- [OrderDAO.java](file://src/main/java/com/example/demo/dao/OrderDAO.java#L61-L79)
...
| 按用户查询订单 | testGetOrdersByUserId_ValidUserId_ReturnsOrders | 返回用户订单列表，验证排序 |
...
6. **完整的CRUD接口**：新增getOrdersByUserId和getAllOrders方法，支持复杂查询
